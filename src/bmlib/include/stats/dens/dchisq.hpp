...
// single input
template<typename T>
statslib_constexpr T dchisq(const T x, const T dof_par, const bool log_form);

statslib_constexpr double dchisq(const double x);
statslib_constexpr double dchisq(const double x, const bool log_form);
statslib_constexpr double dchisq(const double x, const double dof_par);
