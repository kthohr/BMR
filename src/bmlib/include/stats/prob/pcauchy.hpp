...
// single input
template<typename T>
statslib_constexpr T pcauchy(const T x, const T mu_par, const T sigma_par, const bool log_form);

statslib_constexpr double pcauchy(const double x);
statslib_constexpr double pcauchy(const double x, const bool log_form);
statslib_constexpr double pcauchy(const double x, const double mu_par, const double sigma_par);
